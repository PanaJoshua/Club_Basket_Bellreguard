...
<header>
    <a href="{{ route('inicio') }}"><img src="{{ asset('img/login/logotipo.png') }}" alt="Logotipo del club"></a>
    <nav>
        <ul>
    ...
    <a href="{{ route('login') }}"><img src="{{ asset('img/login/icono_de_perfil.png') }}" alt="Icono de perfil"></a>
</header>
    ...
    <div class="footer-contenido">
        ...
        <div class="footer-columna">
            ...
            <div class="redes-sociales">
                ...
                <a href="https://www.instagram.com/basquetbellreguard/"><img src="{{ asset('img/login/instagram.png') }}" alt="Instagram"></a>
            </div>
        </div>
    </div>
